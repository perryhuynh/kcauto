...
export const setPythonConfig = config => (
  (dispatch) => {
    ...
    const pythonConfig = [
      ...
      `LBASGroup1Nodes: ${configTemp.combatLBASGroup1Node1},${configTemp.combatLBASGroup1Node2}`,
      `LBASGroup2Nodes: ${configTemp.combatLBASGroup2Node1},${configTemp.combatLBASGroup2Node2}`,
      `LBASGroup3Nodes: ${configTemp.combatLBASGroup3Node1},${configTemp.combatLBASGroup3Node2}`,
