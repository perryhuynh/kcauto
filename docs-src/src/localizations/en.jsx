...
export const en = {
  ...
  bodyConfig: {
    ...
    scheduledSleepSleepEnabled: 'Enable kcauto-kai Sleep',
    scheduledSleepSleepStartTime: 'kcauto-kai Sleep Start Time',
    scheduledSleepSleepLength: 'kcauto-kai Sleep Length',
