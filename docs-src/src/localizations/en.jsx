...
export const en = {
  ...
  bodyConfig: {
    ...
    shipSwitcherSlot1: 'Slot 1',
    shipSwitcherSlot2: 'Slot 2',
    shipSwitcherSlot3: 'Slot 3',
    shipSwitcherSlot4: 'Slot 4',
    shipSwitcherSlot5: 'Slot 5',
    shipSwitcherSlot6: 'Slot 6',
    shipSwitcherCriteria: 'Switch Criteria',
