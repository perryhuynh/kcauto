...
class Args(object):
    ...
    Attributes:
        ...
        mode (str): specifies which special mode kcauto should run in
    ...
    def set_cfg(self, argv):
        """If kcauto is in custom-cfg mode, this method sets the
    ...
    def set_debug(self, argv):
        """If kcauto is in debug mode, this method sets the appropriate
        attributes
