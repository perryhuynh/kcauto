...
class ExpeditionEnum(EnumBase):
    ...
    E4_31, E4_32 = 31, 32
    E4_D1, E4_D2, E4_D3 = 130, 131, 132
    E5_33, E5_34, E5_35, E5_36, E5_37, E5_38 = 33, 34, 35, 36, 37, 38
    E5_39, E5_40 = 39, 40
    E5_K1, E5_K2 = 140, 141 #using K1, K2 replace E1, E2 to prevent the mixing of the world name and mission name
...
DURATIONS = {
    ...
    104: timedelta(hours=2, minutes=59, seconds=30),
    105: timedelta(hours=3, minutes=29, seconds=30),
    ...
    112: timedelta(hours=2, minutes=49, seconds=30),
    113: timedelta(hours=7, minutes=29, seconds=30),
    114: timedelta(hours=6, minutes=29, seconds=30),
    115: timedelta(hours=5, minutes=49, seconds=30),
    ...
    130: timedelta(hours=1, minutes=59, seconds=30),
    131: timedelta(hours=9, minutes=59, seconds=30),
    132: timedelta(hours=11, minutes=59, seconds=30),
    ...
    140: timedelta(hours=7, minutes=29, seconds=30),
    141: timedelta(hours=3, minutes=4, seconds=30),
    ...
    44: timedelta(hours=9, minutes=59, seconds=30),
    45: timedelta(hours=3, minutes=19, seconds=30),
    46: timedelta(hours=3, minutes=29, seconds=30),
